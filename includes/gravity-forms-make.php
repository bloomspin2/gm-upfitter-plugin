<?php
function gravityFormCustomFieldMake(){
    if (class_exists('GF_Field')) {
    	class CustomFieldsGravityMake extends GF_Field {
    		public $type = 'automotive_matrix_make';


    		public function get_form_editor_field_title() {
    			return esc_attr__('Auto Make', 'txtdomain');
    		}
    		...
    		public function get_field_input($form, $value = '', $entry = null) {
                ...
                $html.='<div class="ginput_container ginput_container_select">';
                    $html.='<select dataSelected="'.sanitize_text_field($value).'" class="auto_matrix_make large gfield_select" id="input_'.$id.'" type="select" name="input_'.$id.'">';
                    $html.='<option value="" disabled selected>Select a Make</option>';
                    $html.='</select>';
                $html.='</div>';
    	...
    	GF_Fields::register(new CustomFieldsGravityMake());
    }
}

add_action( 'plugins_loaded', 'gravityFormCustomFieldMake' );

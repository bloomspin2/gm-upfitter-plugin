<?php
function gravityFormCustomFieldModel(){
    if (class_exists('GF_Field')) {
    	class CustomFieldsGravityModel extends GF_Field {
    		public $type = 'automotive_matrix_model';


    		public function get_form_editor_field_title() {
    			return esc_attr__('Auto Model', 'txtdomain');
    		}
    		...
    		public function get_field_input($form, $value = '', $entry = null) {
                ...
                $html.='<div class="ginput_container ginput_container_select">';
                    $html.='<select dataSelected="'.sanitize_text_field($value).'" class="auto_matrix_model large gfield_select" id="input_'.$id.'" type="select" name="input_'.$id.'">';
                    $html.='<option value="" disabled selected>Select a Model</option>';
                    $html.='</select>';
                $html.='</div>';
    	...
    	GF_Fields::register(new CustomFieldsGravityModel());
    }
}

add_action( 'plugins_loaded', 'gravityFormCustomFieldModel' );
